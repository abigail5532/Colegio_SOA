        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label class="col-form-label">Nombres y Apellidos del Estudiante</label>
            ...
            <div class="form-group">
              ...
              <select name="reunion" id="reunion" class="form-control" required>
                <option selected disabled> -- Seleccionar una Tipo -- </option>
                <option value="Presencial">Presencial</option>
                <option value="Virtual">Virtual</option>
              </select>
            </div>
            
            <div class="form-group" id="grupo-link" style="display: none;">
              <label class="col-form-label">Enlace de la Reunión:</label>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label class="col-form-label">Nombres y Apellidos del familiar:</label>
